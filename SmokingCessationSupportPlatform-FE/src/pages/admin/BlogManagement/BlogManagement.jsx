...
const BlogManagement = () => {
  ...
  const columns = [
    ...
    { title: 'Action', dataIndex: 'action', render: (_, record) => (
      <>
        <button className="action-btn edit" onClick={() => handleEditPost(record)}>Edit</button>
        <button className="action-btn delete" onClick={() => handleDeletePost(record.id)}>Delete</button>
        <button className="action-btn cancel" onClick={() => handleUpdateStatus(record.id, 'REJECTED')}>Cancel publication</button>
      </>
    ) },
  ];
  ...
  return (
    <div className="blog-management-page">
      ...
      <div className="search-filter-row">
        ...
        />
        <button className="add-article-btn" onClick={handleCreatePost}>+ Create new article</button>
      </div>
      ...
      >
        ...
        >
          ...
          <Form.Item
            name="category"
            label="Category"
            rules={[{ required: true, message: 'Please select or enter categories' }]}
          >
            <Select
              mode="tags"
          ...
          >
            <Select>
              ...
              {editingPost && <Select.Option value="PUBLISHED">Published</Select.Option>}
            </Select>
          </Form.Item>

...
const paymentFilterConfig = [
  {
    key: "search",
    type: "text",
    placeholder: "Search by Transaction ID, Email, User ID...",
    value: "",
  },
  {
    key: "package",
  ...
  return (
    <div className="app-layout">
      ...
      <div className="membership-payment-page">
        ...
        <SearchFilterRow
          filters={
            activeTab === "history" ? paymentFilterConfig : planFilterConfig
          }
                  ...
                  <Tag
                    color={
                      selectedTransaction.status === "COMPLETED"
                        ...
                        ? "warning"
                        : selectedTransaction.status === "FAIL"
                        ? "error"
                        : "default"
                    }
                  >
